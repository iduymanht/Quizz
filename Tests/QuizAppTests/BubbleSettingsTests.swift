...
final class BubbleSettingsTests: XCTestCase {
    private let multiAgentBubbleKey = "Quiz.bubble.multiAgentBubbleEnabled"
    private let sessionGroupingKey = "Quiz.bubble.sessionGrouping"
    private let collapseDuplicatesKey = "Quiz.bubble.collapseDuplicates"
