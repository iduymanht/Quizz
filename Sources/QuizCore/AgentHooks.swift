...
public enum HookStyle: Sendable {
    ...
    /// `pi.on(...)` handlers and reports state through the `Quiz hook` CLI.
    case piExtension
}
    ...
    public static func spec(for kind: AgentKind) -> AgentHookSpec? {
        ...
        case .opencode:
            ...
            return AgentHookSpec(
                ...
                events: [],
                settingsPath: home + "/.config/opencode/plugin/Quiz.js")
        case .antigravity:
        ...
        case .copilot:
            ...
            return AgentHookSpec(
                ...
                settingsPath: home + "/.copilot/hooks/Quiz.json")
        case .kiroCLI:
        ...
        case .pi:
            ...
            return AgentHookSpec(
                ...
                events: [],
                settingsPath: home + "/.pi/agent/extensions/Quiz.ts")
        case .cli, .unknown:
            return nil
        }
    }
